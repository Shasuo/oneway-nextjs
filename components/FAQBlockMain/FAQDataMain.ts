export const FAQDataMain = [
    {question: "Почему покупка авто из\u00a0за\u00a0границы выгоднее чем в\u00a0России?", 
